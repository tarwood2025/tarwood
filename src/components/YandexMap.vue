...
const cities = ref<City[]>([
  {
    ...
    dealers: [
      ...
      },
      {
        id: 106,
        name: 'Анфлорс ',
        address: 'ул. Люсиновская д.55',
        phone: '8-(495)-504-36-74',
        coordinates: [55.716974, 37.623581],
      },
      {
        id: 107,
        name: 'Das Parkett Welt(ТЦ Твой Дом)',
        address: 'МКАД, 67-й километр, внешняя сторона(2й этаж)',
        phone: '8-(926)-279-27-92',
        coordinates: [55.817572, 37.388662],
      },
      {
        id: 109,
        name: 'ДА Паркет',
  ...
  },
  {
    ...
    dealers: [
      ...
      {
        id: 208,
        name: 'Мануфактура Таракановых',
        address: 'г.Санкт-Петербург ТЦ Кубатура,  1 линия, 1 этаж',
        phone: '8-981-893-99-19',
        coordinates: [59.875444, 30.367854],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    dealers: [
      ...
      },
      {
        id: 602,
        name: 'Европол',
        address: 'г.Екатеринбург ул.Московская д.47',
        phone: '8-912-285-89-48',
        coordinates: [56.833576, 60.583413],
      },
    ],
  },
  {
  ...
  {
    id: 12,
    center: [49.148998, 55.826521],
    name: 'Казань',
    dealers: [
      {
        id: 1201,
        name: 'Стеллар',
        address: 'просп. Ямашева, 93',
        phone: '8-987-273-77-77',
        coordinates: [55.826521, 49.148998],
      },
    ],
  },
  {
    id: 13,
    center: [56.009657, 54.727785],
    name: 'Уфа',
    dealers: [
      {
        id: 1301,
        name: 'Море Пола(ЦТР Радуга)',
        address: 'ул. Менделеева д.137Б',
        phone: '8-919-612-22-82',
        coordinates: [54.712643, 55.989851],
      },
    ],
  },
])
